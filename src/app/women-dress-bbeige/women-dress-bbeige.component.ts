...
@Component({
  selector: 'app-women-dress-bbeige',
  templateUrl: './women-dress-bbeige.component.html',
  styleUrls: ['./women-dress-bbeige.component.css']
})
export class WomenDressBbeigeComponent implements OnInit {
