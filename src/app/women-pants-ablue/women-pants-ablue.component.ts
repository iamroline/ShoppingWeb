...
@Component({
  selector: 'app-women-pants-ablue',
  templateUrl: './women-pants-ablue.component.html',
  styleUrls: ['./women-pants-ablue.component.css']
})
export class WomenPantsAblueComponent implements OnInit {
