...
@Component({
  selector: 'app-women-activeset2',
  templateUrl: './women-activeset2.component.html',
  styleUrls: ['./women-activeset2.component.css']
})
export class WomenActiveset2Component implements OnInit {
