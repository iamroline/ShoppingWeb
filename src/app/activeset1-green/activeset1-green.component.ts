...
@Component({
  selector: 'app-activeset1-green',
  templateUrl: './activeset1-green.component.html',
  styleUrls: ['./activeset1-green.component.css']
})


export class Activeset1GreenComponent implements OnInit {
