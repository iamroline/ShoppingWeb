...
@Component({
  selector: 'app-women-pants-abrown',
  templateUrl: './women-pants-abrown.component.html',
  styleUrls: ['./women-pants-abrown.component.css']
})
export class WomenPantsAbrownComponent implements OnInit {
