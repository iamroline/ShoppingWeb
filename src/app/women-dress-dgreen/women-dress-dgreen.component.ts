...
@Component({
  selector: 'app-women-dress-dgreen',
  templateUrl: './women-dress-dgreen.component.html',
  styleUrls: ['./women-dress-dgreen.component.css']
})
export class WomenDressDgreenComponent implements OnInit {
