...
@Component({
  selector: 'app-women-dress-bgrey',
  templateUrl: './women-dress-bgrey.component.html',
  styleUrls: ['./women-dress-bgrey.component.css']
})
export class WomenDressBGreyComponent implements OnInit {
