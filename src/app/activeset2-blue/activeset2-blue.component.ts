...
@Component({
  selector: 'app-activeset2-blue',
  templateUrl: './activeset2-blue.component.html',
  styleUrls: ['./activeset2-blue.component.css']
})
export class Activeset2BlueComponent implements OnInit {
