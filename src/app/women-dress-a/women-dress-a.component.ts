...
@Component({
  selector: 'app-women-dress-a',
  templateUrl: './women-dress-a.component.html',
  styleUrls: ['./women-dress-a.component.css']
})
export class WomenDressAComponent implements OnInit {
