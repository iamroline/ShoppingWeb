...
@Component({
  selector: 'app-women-dress-c',
  templateUrl: './women-dress-c.component.html',
  styleUrls: ['./women-dress-c.component.css']
})
export class WomenDressCComponent implements OnInit {
