...
@Component({
  selector: 'app-women-dress-dblack',
  templateUrl: './women-dress-dblack.component.html',
  styleUrls: ['./women-dress-dblack.component.css']
})
export class WomenDressDblackComponent implements OnInit {
